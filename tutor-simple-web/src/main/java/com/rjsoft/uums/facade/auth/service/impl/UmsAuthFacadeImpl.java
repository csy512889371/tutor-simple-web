package com.rjsoft.uums.facade.auth.service.impl;

import com.google.common.collect.Sets;
import com.rjsoft.common.entity.enums.AuthStatus;
...
import com.rjsoft.uums.core.auth.service.UmsAclService;
...
import com.rjsoft.uums.core.org.service.UmsUserOrgDepartmentPosService;
		...
		if(acls!=null){
			for(UmsAcl acl:acls){
				if(Resource.RESOURCE_MENU.equals(acl.getRtype())){
					...
					UmsControllerResources controllerResources = umsControllerResService.getOne(acl.getRid());
