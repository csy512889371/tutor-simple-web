package com.rjsoft.uums.core.auth.service;
            ...
            if(umsAcl!=null){
                ...
                if(map!=null){
                    ...
                    for(String buttonId:buttonIds){
                        UmsButton umsButton = umsButtonRepository.getOne(buttonId);
            ...
            if(umsAcl!=null){
                ...
                if(map!=null){
                    ...
                    for(String controllerOperId:controllerOperIds){
                        UmsControllerOper controllerOper = umsControllerOperRepository.getOne(controllerOperId);
